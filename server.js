...
// Fix: Configure trust proxy for rate limiting
...
const limiter = rateLimit({
  ...
  // Fix: Add key generator that works with proxy
  keyGenerator: (req) => {
    return req.ip; // Use the IP from Express (respects trust proxy)
  }
});
...
// africa's talking ussd middleware
